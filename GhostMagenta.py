...
class GhostMagenta(Ghost.Ghost):
    def __init__(self, screen_size):
        super().__init__()
        self.image = pygame.image.load("Pics/Ghost_magenta.png")
    ...
    def update(self):
        ...
        if self.lives == 1:
            if self.x_val > 0:
                self.image = pygame.image.load("Pics//Ghost_magenta//r.png")
            if self.x_val < 0:
                self.image = pygame.image.load("Pics//Ghost_magenta//l.png")
            if self.y_val > 0:
                self.image = pygame.image.load("Pics//Ghost_magenta//u.png")
            if self.y_val < 0:
                self.image = pygame.image.load("Pics//Ghost_magenta//d.png")
        # print(self.x_val)
