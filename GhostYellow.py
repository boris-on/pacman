...
class GhostYellow(Ghost.Ghost):
    def __init__(self, screen_size):
        super().__init__()
        self.image = pygame.image.load("Pics/Ghost_yellow.png")
    ...
    def update(self):
        ...
        if self.lives == 1:
            if self.x_val > 0:
                self.image = pygame.image.load("Pics//Ghost_yellow//r.png")
            if self.x_val < 0:
                self.image = pygame.image.load("Pics//Ghost_yellow//l.png")
            if self.y_val > 0:
                self.image = pygame.image.load("Pics//Ghost_yellow//u.png")
            if self.y_val < 0:
                self.image = pygame.image.load("Pics//Ghost_yellow//d.png")
        # print(self.x_val)
